...
namespace GuXin.Core.ManageUser
{
    public class UserContext
    {
        ...
        public UserInfo GetUserInfo(int userId)
        {
            ...
            var quantity = DBServerProvider.DbContext.Set<User_XinPraise>().FirstOrDefault(m => m.UserId == _userInfo.User_Id)?.Quantity;
            _userInfo.XinZan = XinZan(quantity.ToInt());
        ...
        /// </summary> 
        /// <returns></returns>
        private IList<int> XinZan(int number)
        {
