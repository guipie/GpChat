...
namespace GuXin.Core.Configuration
{
    public static class AppSetting
    {
        ...
        public static string[] ImServerUrls { get; private set; }
        public static AliyunConfig AliyunConfig { get; private set; }
        ...
        public static void Init(IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.Configure<AliyunConfig>(configuration.GetSection("AliyunConfig"));
            ...
            GlobalFilter.Actions = GlobalFilter.Actions ?? System.Array.Empty<string>();

            _connection = provider.GetRequiredService<IOptions<Connection>>().Value;

            AliyunConfig = provider.GetRequiredService<IOptions<AliyunConfig>>().Value ?? new AliyunConfig();


            ExpMinutes = (configuration["ExpMinutes"] ?? "120").GetInt();
            ImServerUrls = configuration["ImServerUrls"].Split(",", System.StringSplitOptions.RemoveEmptyEntries);
    ...
    public class AliyunConfig
    {
        ...
        public AliyunSmsTemplate RegisterTemp { get; set; }
    }
