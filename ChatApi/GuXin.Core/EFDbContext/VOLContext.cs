...
namespace GuXin.Core.EFDbContext
{
    public class GuXinContext : DbContext, IDependency
    {
        /// <summary>
        /// 数据库连接名称 
        /// </summary>
        ...
        public GuXinContext(string connction)
            : base()
        {
            DataBaseName = connction;
        }

        public GuXinContext(DbContextOptions<GuXinContext> options)
            : base(options)
        {
