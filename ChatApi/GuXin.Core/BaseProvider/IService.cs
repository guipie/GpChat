...
namespace GuXin.Core.BaseProvider
{
    public interface IService<T> where T : BaseEntity
    {
        ...
        WebResponseContent Upload(List<IFormFile> files, string folder = ""); 
        ...
        WebResponseContent UpdateEntity(T entity, Expression<Func<T, object>> properties, bool validationEntity = true);
