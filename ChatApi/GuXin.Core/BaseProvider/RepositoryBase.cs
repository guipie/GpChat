...
namespace GuXin.Core.BaseProvider
{
    public abstract class RepositoryBase<TEntity> where TEntity : BaseEntity
    {
        ...
        public RepositoryBase(GuXinContext dbContext)
        {
            this.DefaultDbContext = dbContext ?? throw new Exception("dbContext未实例化。");
        }

        private GuXinContext DefaultDbContext { get; set; }
        private GuXinContext EFContext
        {
            get
            {
        ...
        public virtual GuXinContext DbContext
        {
        ...
        public virtual void Delete(Expression<Func<TEntity, bool>> predicate, bool saveChanges)
        { 
