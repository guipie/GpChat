<template>
	<view>
		...
		<view ref="myp-popup" v-if="helpShow" @touchmove.stop="toPrevent" @click.stop="toPrevent" :class="['myp-popup', 'myp-flex-column', 'myp-bg-'+bgType]" :style="boxStyle+mrPopStyle + noWeexAni">
			<slot></slot>
		</view>
	</view>
</template>
